...
const bandsData = [
  { bandName: 'Metallica', genre: 'Heavy Metal', description: 'Banda icónica de heavy metal.', email: 'metallica@gmail.com' },
  { bandName: 'Linkin Park', genre: 'Nu Metal', description: 'Banda revolucionaria del nu metal.', email: 'linkinpark@gmail.com' },
  { bandName: 'Iron Maiden', genre: 'Heavy Metal', description: 'Leyenda del heavy metal británico.', email: 'ironmaiden@gmail.com' },
  { bandName: 'Slayer', genre: 'Thrash Metal', description: 'Banda legendaria del thrash metal.', email: 'slayer@gmail.com' },
  { bandName: 'AC/DC', genre: 'Hard Rock', description: 'Iconos del hard rock australiano.', email: 'acdc@gmail.com' },
  { bandName: 'Pantera', genre: 'Groove Metal', description: 'Revolucionarios del groove metal.', email: 'pantera@gmail.com' },
  { bandName: 'Megadeth', genre: 'Thrash Metal', description: 'Pioneros del thrash con riffs veloces.', email: 'megadeth@gmail.com' },
  { bandName: 'Judas Priest', genre: 'Heavy Metal', description: 'Los dioses del metal británico.', email: 'judaspriest@gmail.com' },
  { bandName: 'Black Sabbath', genre: 'Doom Metal', description: 'Creadores del heavy metal oscuro.', email: 'blacksabbath@gmail.com' },
  { bandName: 'Dream Theater', genre: 'Progressive Metal', description: 'Maestros de la complejidad musical.', email: 'dreamtheater@gmail.com' },
  { bandName: 'Opeth', genre: 'Progressive Death Metal', description: 'Fusionan la brutalidad con lo melódico.', email: 'opeth@gmail.com' },
  { bandName: 'Nightwish', genre: 'Symphonic Metal', description: 'Pioneros del metal sinfónico moderno.', email: 'nightwish@gmail.com' },
  { bandName: 'Children of Bodom', genre: 'Melodic Death Metal', description: 'Innovadores del metal melódico extremo.', email: 'cobodom@gmail.com' },
  { bandName: 'Behemoth', genre: 'Blackened Death Metal', description: 'Oscuridad y brutalidad en su máxima expresión.', email: 'behemoth@gmail.com' },
  { bandName: 'Lamb of God', genre: 'Groove Metal', description: 'Fuerza y agresividad en cada riff.', email: 'lambofgod@gmail.com' },
  { bandName: 'System of a Down', genre: 'Alternative Metal', description: 'Metal alternativo con influencias étnicas.', email: 'soad@gmail.com' },
  { bandName: 'Disturbed', genre: 'Alternative Metal', description: 'Éxitos que combinan potencia y melodía.', email: 'disturbed@gmail.com' },
  { bandName: 'Slipknot', genre: 'Nu Metal', description: 'Energía brutal con una puesta en escena única.', email: 'slipknot@gmail.com' },
  { bandName: 'Gojira', genre: 'Progressive Death Metal', description: 'Conciencia ecológica con riffs demoledores.', email: 'gojira@gmail.com' },
  { bandName: 'Mastodon', genre: 'Sludge Metal', description: 'Narrativas épicas con técnica impecable.', email: 'mastodon@gmail.com' },
  { bandName: 'Korn', genre: 'Nu Metal', description: 'Fundadores del sonido nu metal moderno.', email: 'korn@gmail.com' },
  { bandName: 'Sepultura', genre: 'Thrash Metal', description: 'Poder sudamericano en el metal extremo.', email: 'sepultura@gmail.com' },
  { bandName: 'Deftones', genre: 'Alternative Metal', description: 'Metal atmosférico con influencias shoegaze.', email: 'deftones@gmail.com' },
  { bandName: 'Tool', genre: 'Progressive Metal', description: 'Misticismo, arte y polirritmos complejos.', email: 'tool@gmail.com' },
  { bandName: 'The Beatles', genre: 'Rock', description: 'Los pioneros del rock moderno con una influencia inigualable.', email: 'beatles@gmail.com' },
  { bandName: 'The Rolling Stones', genre: 'Rock', description: 'Energía y rebeldía en estado puro.', email: 'rollingstones@gmail.com' },
  { bandName: 'Pink Floyd', genre: 'Progressive Rock', description: 'Los maestros de los paisajes sonoros psicodélicos.', email: 'pinkfloyd@gmail.com' },
  { bandName: 'Led Zeppelin', genre: 'Hard Rock', description: 'Los pioneros del hard rock con himnos inmortales.', email: 'ledzeppelin@gmail.com' },
  { bandName: 'Queen', genre: 'Rock', description: 'Innovación y espectáculo en cada nota.', email: 'queen@gmail.com' },
  { bandName: 'The Doors', genre: 'Psychedelic Rock', description: 'Letras poéticas y atmósferas hipnóticas.', email: 'thedoors@gmail.com' },
  { bandName: 'Deep Purple', genre: 'Hard Rock', description: 'Potencia y virtuosismo con riffs inolvidables.', email: 'deeppurple@gmail.com' },
  { bandName: 'The Who', genre: 'Rock', description: 'Rebeldía y óperas rock que marcaron una época.', email: 'thewho@gmail.com' },
  { bandName: 'Radiohead', genre: 'Alternative Rock', description: 'Expresión emocional y experimentación sónica.', email: 'radiohead@gmail.com' },
  { bandName: 'Nirvana', genre: 'Grunge', description: 'La banda que definió una generación con su sonido crudo.', email: 'nirvana@gmail.com' },
  { bandName: 'Pearl Jam', genre: 'Grunge', description: 'Pasión y letras profundas que marcaron el grunge.', email: 'pearljam@gmail.com' },
  { bandName: 'Foo Fighters', genre: 'Alternative Rock', description: 'Himnos modernos del rock con energía desbordante.', email: 'foofighters@gmail.com' },
  { bandName: 'Red Hot Chili Peppers', genre: 'Funk Rock', description: 'Fusionan el rock con funk y un estilo único.', email: 'rhcp@gmail.com' },
  { bandName: 'Green Day', genre: 'Punk Rock', description: 'Iconos del punk rock de los 90.', email: 'greenday@gmail.com' },
  { bandName: 'The Offspring', genre: 'Punk Rock', description: 'Punk enérgico con letras pegajosas.', email: 'theoffspring@gmail.com' },
  { bandName: 'Blink-182', genre: 'Pop Punk', description: 'El sonido irreverente del pop punk.', email: 'blink182@gmail.com' },
  { bandName: 'Muse', genre: 'Alternative Rock', description: 'Rock épico con influencias electrónicas y progresivas.', email: 'muse@gmail.com' },
  { bandName: 'The Killers', genre: 'Alternative Rock', description: 'Pop rock con un sonido indie y letras nostálgicas.', email: 'thekillers@gmail.com' },
  { bandName: 'The Black Keys', genre: 'Blues Rock', description: 'Rock con raíces profundas en el blues.', email: 'theblackkeys@gmail.com' },
  { bandName: 'Arctic Monkeys', genre: 'Indie Rock', description: 'Riffs pegajosos y actitud indie.', email: 'arcticmonkeys@gmail.com' }
];
